...
x2 [c("first", "third")] 
# #the value that was put into the element is printed below the concatenated words
# first third 
# 3     9

sequence3 <- (-3:2)
sequence3 [2] <- 0
sequence3 #the 2nd element in the sequence was changed to 0 
#[1] -3 -2 -1  0  1  2

fuel_data <- data.frame(
  Months = c("price_per_liter", "purchase_quantity_liters"),
  Jan = c(52.50, 25),
  Feb = c(57.25, 30),
  March = c(60.00, 40),
  Apr = c(65.00,50),
...
# 1          price_per_liter 52.5 57.25    60  65 74.25   54
# 2 purchase_quantity_liters 25.0 30.00    40  50 10.00   45

weighted_mean <- weighted.mean(fuel_data$Jan, fuel_data$Feb, fuel_data$March, fuel_data$Apr,
                               fuel_data$May, fuel_data$June)
weighted_mean # the average fuel expenditure of Mr. Cruz from January to June is 43.04441
#[1] 43.04441
...
load("Ranks.RData")
View(subset_PowerRankings)# The output of this line of code are the ten elements from index 10 to 20
...
saveRDS(selectedColumns, file = "new5.rds") 
...
# [[16]]
# [1] "potato"
length(add5VegList) # there are 16 data points in the add5VegList list
# [1] 16
...
length(VegListMinus) # There are 13 vegetables left in this list
# [1] 13
